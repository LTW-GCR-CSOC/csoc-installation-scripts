...
sudo mv $SCRIPTSDIR/cowrie.logrotate -f /etc/logrotate.d/cowrie
sudo chmod 644 /etc/logrotate.d/cowrie
sudo chown root:root /etc/logrotate.d/cowrie
echo "Setting service to autostart..." >>$SCRIPTSDIR/SETUP-RUN.TXT
sudo mv $SCRIPTSDIR/cowrie.service -f /etc/systemd/system/cowrie.service
sudo chmod 755 /etc/systemd/system/cowrie.service
sudo chown root:root /etc/systemd/system/cowrie.service
sudo mv $SCRIPTSDIR/cowrie.socket -f /etc/systemd/system/cowrie.socket
sudo chmod 755 /etc/systemd/system/cowrie.socket
sudo chown root:root /etc/systemd/system/cowrie.socket
